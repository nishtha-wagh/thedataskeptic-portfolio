...
>
  <div className="relative w-[500px] h-[400px] flex items-center justify-center">
    ...
    <div
      className="absolute top-[85px] right-[65px] px-4 py-2.5 rounded-2xl bg-mint-light border border-border animate-float"
    ...
    <div
      className="absolute top/2  right-[150px] px-6 py-2.5 rounded-2xl bg-coral-light border border-border animate-float"
    ...
    <div
      className="absolute bottom-[120px] left-[85px] px-5 py-2.5 rounded-2xl bg-lavender-light border border-border animate-float"
