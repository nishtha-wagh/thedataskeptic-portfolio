...
>
  <div className="relative">
    ...
    <div
      className="absolute top-0 left-[-4px] px-4 py-2.5 rounded-2xl bg-cream border border-border animate-float"
    ...
    <div
      className="absolute top-[calc(50%-8px)] -translate-y-1/2 right-[-8px] px-4 py-2.5 rounded-2xl bg-coral-light border border-border animate-float"
