...
>
  <div className="relative w-[420px] h-[380px]">
    ...
    <div
      className="absolute top-[15px] left-0 px-4 py-2.5 rounded-2xl bg-cream border border-border animate-float"
    ...
    <div
      className="absolute top-[15px] right-0 px-4 py-2.5 rounded-2xl bg-mint-light border border-border animate-float"
    ...
    <div
      className="absolute top-1/2 -translate-y-1/2 right-0 px-4 py-2.5 rounded-2xl bg-coral-light border border-border animate-float"
    ...
    <div
      className="absolute bottom-[15px] right-0 px-4 py-2.5 rounded-2xl bg-peach-light border border-border animate-float"
    ...
    <div
      className="absolute bottom-[15px] left-0 px-4 py-2.5 rounded-2xl bg-lavender-light border border-border animate-float"
