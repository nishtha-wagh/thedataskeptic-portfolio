...
>
  <div className="relative">
    ...
    <div
      className="absolute bottom-0 right-0 px-4 py-2.5 rounded-2xl bg-peach-light border border-border animate-float"
    ...
    <div
      className="absolute bottom-0 left-0 px-4 py-2.5 rounded-2xl bg-lavender-light border border-border animate-float"
